		...
		<div class="col-md-10 mx-auto">
			<div class="card mb-3">
				<div class="card-header">
					<span>Produk</span>
					<a href="<?= base_url('produk/create') ?>" class="btn btn-sm btn-secondary">Tambah</a>
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<?= form_open(base_url("/produk/delete/$row->id"), ['method' => 'POST']) ?>
									<?= form_hidden('id', $row->id) ?>
									<a href="<?= base_url("/produk/edit/$row->id") ?>" class="btn btn-sm">
